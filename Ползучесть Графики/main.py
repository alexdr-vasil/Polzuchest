...
plt.plot(x1_list, exponential(x1_list, *Parameters_exp), label="Теор. кривая на 1 участке")
plt.plot(x2_list, exponential_2(x2_list, *Parameters_exp2), label="Теор. кривая на 2 участке")
plt.plot(x3_list, relaxation_e(x3_list, *Parameters_rel_exp), label="Теор. кривая релаксации")
axes = plt.gca()
axes.set_ylim([0, 7])
